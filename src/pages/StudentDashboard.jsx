      ...
      <div className='bg-white border-top border-opacity-25 border-secondary px-4 py-2 w-100 d-flex flex-column gap-3'>
        ...
        <div className=' mt-1 d-flex justify-content-between'>
          ...
          <button className='btn border-0 p-0 d-flex flex-column align-items-center' onClick={() =>
            ...
            <small className={`fw-medium transition ${activeTab === 'status'
              ? 'activeTabText'
              : ''
              }`}>Home</small>
          </button>
          ...
          <button className='btn border-0 p-0 d-flex flex-column align-items-center' onClick={() =>
            ...
            <small className={`fw-medium transition ${activeTab === 'students'
              ? 'activeTabText'
              : ''
              }`}>Students</small>
          </button>
          ...
          <button className='btn border-0 p-0 d-flex flex-column align-items-center' onClick={() =>
            ...
            <div className={` px-4 p-1 rounded-5 transition-colors ${activeTab === 'bank'
              ...
              {activeTab === 'bank'
                ...
                : <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-pentagon" viewBox="0 0 16 16">
            ...
            <small className={`fw-medium transition ${activeTab === 'bank'
              ? 'activeTabText'
              : ''
              }`}>Banking</small>
          </button>
          ...
          <button className='btn border-0 p-0 d-flex flex-column align-items-center' onClick={() =>
            ...
            <small className={`fw-medium transition ${activeTab === 'profile'
              ? 'activeTabText'
              : ''
              }`}>Profile</small>
          </button>
