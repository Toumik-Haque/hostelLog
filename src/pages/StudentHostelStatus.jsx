...
export default function StudentHostelStatus({
  ...
  return (
    ...
    <div className='containerActive2 h-100 overflow-auto py-3 hide-scrollbar'>

      {/* STUDENT STATUS MANAGE */}
      <div className='cardsContainer2 border-0 mx-4'>
      ...
      {/* HOSTEL STATUS CARDS */}
      <div className='cardsContainer2 border-0 mx-4 d-flex flex-column gap-3'>
