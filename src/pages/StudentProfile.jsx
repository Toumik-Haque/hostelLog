...
export default function StudentProfile({ user, fetchingData, }) {
  ...
  return (
    ...
    <div className='h-100 overflow-auto py-3 hide-scrollbar disable-scroll containerActive2'>

      <div className='d-flex profile-container'>

        <div className='d-none screen-show mx-4'>
        ...
        <div className='screen-scroll'>
          <div className="mx-4 border-0">
            ...
            <p className={`screen-hide badge mb-2 text-center ${user.hostelStatus === 'IN' ? 'bg-official' : 'bg-danger'} `}>
              {user.hostelStatus === 'IN' ?
                'PRESENT NOW' : 'ABSENT NOW'}
            </p>

            <h4 className='screen-hide mb-3'>{user.name}</h4>
            ...
            <button
              className="mt-4 w-100 btn p-2 text-white border-0 bg-official d-flex gap-2 align-items-center justify-content-center screen-hide"
              onClick={() => setShowModal(true)}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-fill" viewBox="0 0 16 16">
                <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z" />
            ...
            <p className='screen-hide color-official mt-4'>Contact Hostel Authority to update any of your other details.</p>
